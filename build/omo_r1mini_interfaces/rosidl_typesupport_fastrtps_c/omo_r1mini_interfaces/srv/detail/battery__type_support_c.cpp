...
#include "omo_r1mini_interfaces/srv/detail/battery__rosidl_typesupport_fastrtps_c.h"
...
using _Battery_Request__ros_msg_type = omo_r1mini_interfaces__srv__Battery_Request;
...
{
  return max_serialized_size_omo_r1mini_interfaces__srv__Battery_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, omo_r1mini_interfaces, srv, Battery_Request)() {
...
using _Battery_Response__ros_msg_type = omo_r1mini_interfaces__srv__Battery_Response;
...
{
  return max_serialized_size_omo_r1mini_interfaces__srv__Battery_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, omo_r1mini_interfaces, srv, Battery_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, omo_r1mini_interfaces, srv, Battery)() {
