...
#include <stddef.h>
#include "omo_r1mini_interfaces/srv/detail/color__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  omo_r1mini_interfaces__srv__Color_Request__init(message_memory);
}

void Color_Request__rosidl_typesupport_introspection_c__Color_Request_fini_function(void * message_memory)
{
  omo_r1mini_interfaces__srv__Color_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Color_Request__rosidl_typesupport_introspection_c__Color_Request_message_member_array[3] = {
  {
    ...
    offsetof(omo_r1mini_interfaces__srv__Color_Request, red),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(omo_r1mini_interfaces__srv__Color_Request, green),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(omo_r1mini_interfaces__srv__Color_Request, blue),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Color_Request__rosidl_typesupport_introspection_c__Color_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(omo_r1mini_interfaces__srv__Color_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, omo_r1mini_interfaces, srv, Color_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  omo_r1mini_interfaces__srv__Color_Response__init(message_memory);
}

void Color_Response__rosidl_typesupport_introspection_c__Color_Response_fini_function(void * message_memory)
{
  omo_r1mini_interfaces__srv__Color_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Color_Response__rosidl_typesupport_introspection_c__Color_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(omo_r1mini_interfaces__srv__Color_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Color_Response__rosidl_typesupport_introspection_c__Color_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(omo_r1mini_interfaces__srv__Color_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_omo_r1mini_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, omo_r1mini_interfaces, srv, Color_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_members = {
  "omo_r1mini_interfaces__srv",  // service namespace
  "Color",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_Request_message_type_support_handle,
  NULL  // response message
  // omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_Response_message_type_support_handle
};

static rosidl_service_type_support_t omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_type_support_handle = {
  0,
  &omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, omo_r1mini_interfaces, srv, Color)() {
  if (!omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_type_support_handle.typesupport_identifier) {
    omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, omo_r1mini_interfaces, srv, Color_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, omo_r1mini_interfaces, srv, Color_Response)()->data;
  }

  return &omo_r1mini_interfaces__srv__detail__color__rosidl_typesupport_introspection_c__Color_service_type_support_handle;
}
