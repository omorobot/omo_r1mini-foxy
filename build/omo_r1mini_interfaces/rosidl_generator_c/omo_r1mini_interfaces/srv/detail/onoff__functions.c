...
{
  omo_r1mini_interfaces__srv__Onoff_Request * msg = (omo_r1mini_interfaces__srv__Onoff_Request *)malloc(sizeof(omo_r1mini_interfaces__srv__Onoff_Request));
  if (!msg) {
    return NULL;
  }
...
omo_r1mini_interfaces__srv__Onoff_Request__Sequence__init(omo_r1mini_interfaces__srv__Onoff_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (omo_r1mini_interfaces__srv__Onoff_Request *)calloc(size, sizeof(omo_r1mini_interfaces__srv__Onoff_Request));
    if (!data) {
      return false;
    }
...
{
  omo_r1mini_interfaces__srv__Onoff_Request__Sequence * array = (omo_r1mini_interfaces__srv__Onoff_Request__Sequence *)malloc(sizeof(omo_r1mini_interfaces__srv__Onoff_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  omo_r1mini_interfaces__srv__Onoff_Response * msg = (omo_r1mini_interfaces__srv__Onoff_Response *)malloc(sizeof(omo_r1mini_interfaces__srv__Onoff_Response));
  if (!msg) {
    return NULL;
  }
...
omo_r1mini_interfaces__srv__Onoff_Response__Sequence__init(omo_r1mini_interfaces__srv__Onoff_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (omo_r1mini_interfaces__srv__Onoff_Response *)calloc(size, sizeof(omo_r1mini_interfaces__srv__Onoff_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  omo_r1mini_interfaces__srv__Onoff_Response__Sequence * array = (omo_r1mini_interfaces__srv__Onoff_Response__Sequence *)malloc(sizeof(omo_r1mini_interfaces__srv__Onoff_Response__Sequence));
  if (!array) {
    return NULL;
  }
