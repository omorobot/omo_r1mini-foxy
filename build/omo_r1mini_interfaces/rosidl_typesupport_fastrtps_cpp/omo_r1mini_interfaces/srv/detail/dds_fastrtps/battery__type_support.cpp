...
#include "omo_r1mini_interfaces/srv/detail/battery__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Battery_Request)() {
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery_Request__handle;
}
...
{
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Battery_Response)() {
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery_Response__handle;
}
...
{
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, omo_r1mini_interfaces, srv, Battery)() {
  return &omo_r1mini_interfaces::srv::typesupport_fastrtps_cpp::_Battery__handle;
}
